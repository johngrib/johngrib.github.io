...
updated : 2018-04-01 00:34:48 +0900
tags    : math
toc     : true
public  : true
parent  : algorithm
...
이 문제는 이미 해결된 것으로, 해답은 `37%` 이다.

다음의 방법을 수행하면 된다.

* $$ n \times 0.37 $$ 명까지 면접을 보고 **불합격**시킨다.
* 계속해서 1명씩 면접을 본다.
* 지원자가 불합격된 지원자들보다 뛰어나지 않다면 불합격시킨다.
* 지원자가 앞에서 불합격된 지원자들보다 뛰어나다면 합격시키고 채용을 종료한다.
