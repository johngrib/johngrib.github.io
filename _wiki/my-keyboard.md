...
updated : 2019-09-26 19:22:47 +0900
tag     : keyboard
toc     : true
public  : true
parent  : index
...
타이핑을 하면서 손가락이 아프다면 자신의 타이핑 습관을 잘 관찰해 원인을 찾아야 한다.
...
* 왼쪽 새끼손가락 통증
    * 왼쪽 Shift, Ctrl 키를 새끼손가락 옆으면으로 누르는 잘못된 습관이 있어 손가락 관절염에 걸림.

타이핑 습관을 고치는 것으로 천천히 해결할 수도 있었겠지만, 내 경우에는 문제가 되는 키의 위치를 스페이스바 옆으로 옮겨주었다.

![layout01](/post-img/my-keyboard/layout01.jpg )

* 스페이스 오른쪽
    * L1: 다른 키보드의 FN 키에 해당된다. 엄지손가락으로 누른다.
...
나는 어깨 통증의 원인을 이러한 불균형에 있다고 생각했다.
...
* 스프링 압력이 큰 키보드를 사용할 때 새끼 손가락으로 키를 누르는 느낌이 상대적으로 어렵게 느껴질 수 있는데, 이런 상황이 싫다면 리얼포스 차등 키보드가 좋다. 새끼손가락이 누르는 키 밑에 약한 스프링이 배치되어 있다.
...
* 클릭감이 있는 기계식 키보드를 쓰고 있다면, 리니어 방식의 기계식 키보드나 정전식 무접점 키보드로 갈아탄다.
...
* 키가 올라올 때 키보드 상판을 때리는 소리가 의외로 시끄럽다.
    * 이 문제를 해결하려면 키보드를 분해해서 키 아답터에 고무링을 끼워주면 된다.
