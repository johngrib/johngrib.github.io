...
updated : 2019-10-05 20:38:55 +0900
tag     : design-pattern
toc     : true
public  : true
...
* Component는 장식을 추가할 베이스가 되는 역할이다.
* 상속 구조를 통해 장식과 베이스가 같은 인터페이스를 갖게 해야 한다.
    * 투과적 인터페이스: 장식으로 계속해서 감싸도 베이스의 메소드는 계속 사용할 수 있다.
* 코드를 수정하지 않고도 준비된 장식을 추가해 기능을 추가할 수 있도록 생각해서 구현한다.
* 데코레이터 패턴을 사용하면 비슷한 성질의 작은 클래스가 많이 만들어질 수 있다는 단점을 고려한다.
