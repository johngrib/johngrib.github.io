...
> 한편, [[/algorithm/quick-sort]]{빠른정렬}은 오직 평균 경우에서만 효율적이며, 해당 최악의 경우는 $$N^2$$의 규모이다.
...
배열에서 인접한 항목끼리 비교되는 상황이 드물기 때문에 [[/algorithm/quick-sort]]{퀵-정렬}, [[/algorithm/merge-sort]]{병합 정렬}, 심지어 [[/algorithm/shell-sort]]{셸-정렬}과 비교해서도 캐시 미스(cache miss)의 발생 횟수가 훨씬 더 많다.
>
