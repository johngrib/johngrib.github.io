...
updated : 2018-11-25 21:47:03 +0900
tags    : cs
toc     : true
public  : true
...
$$
\begin{array}{rrr}
  \uparrow \downarrow 1 &           &           &           &            &      & \uparrow \downarrow 0,1 \\
\right{} \bboxed{ q_0 } & \right{0} & \bboxed{0} & \right{0} & \bboxed{00} & \right{1} & \boxed{001} \\
\end{array}
$$
...
$$
\begin{array}{rrr}
  \uparrow \downarrow 1 &           &           & & \uparrow \downarrow 0,1 & & \uparrow \downarrow 0,1 \\
\right{} \bboxed{ q_0 } & \right{0} & \bboxed{0} & \right{0} & \bboxed{00} & \right{1} & \boxed{001} \\
\end{array}
$$
