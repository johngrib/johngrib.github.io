...
updated : 2018-03-31 12:04:35 +0900
tags    : tools 미세먼지
toc     : true
public  : true
parent  : useful-site
...
| 클래스 | 효율(%) | 오염 물질 유형                        |
|--------|---------|---------------------------------------|
| N100   | 99.97   | 고체 및 수성 미립자(비 오일 에어로졸) |
| N99    | 99      | ..                                    |
| N95    | 95      | ..                                    |
| R100   | 99.97   | 모든 오염 물질                        |
| R99    | 99      | ..                                    |
...
* 위의 등급을 부여받기 위해서는 여러 조건을 만족해야 하며, 초미세 먼지의 사이즈는 **0.3μm**이 기준이다.
* 따라서 PM2.5를 걱정하고 있다면 위의 등급 표를 보고 마스크나 필터 선택에 활용할 수 있다.
