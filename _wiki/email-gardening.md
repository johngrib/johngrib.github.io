...
updated : 2020-01-19 13:04:36 +0900
tag     : email
toc     : true
public  : true
parent  : [[my-lifehack]]
...
할 일은 처리하고 분류하거나 삭제하면 된다. 아래 사진의 경우.
...
정도로 부탁을 해서 이메일로 받으면 기억을 못 하는 문제가 심플하게 해결된다.

받은 편지함을 열어보면 있는 메일 중에 있을 것이기 때문이다.
...
내 메일함에는 중요한 정보들이 날아드는 소식통이어야 한다.
