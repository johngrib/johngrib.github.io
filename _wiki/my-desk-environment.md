...
updated : 2020-02-09 21:10:53 +0900
tag     : 
toc     : true
public  : true
parent  : [[my-lifehack]]
...
* 높낮이, 팔걸이 각도, 팔걸이 높낮이, 목받침 높낮이, 틸팅 각도, 틸팅 강도, 좌판 깊이 등을 조절할 수 있어서 편리했다.
    * 좌판 깊이를 바꿔보지 않은 사람은 조금 깊에 넣어보는 테스트를 해보길 권한다. 바른 자세를 취하기 더 좋아질 수 있다.
...
| ![freedom 앞]( /post-img/my-desk-environment/freedom-front.png ) | ![freedom 뒤]( /post-img/my-desk-environment/freedom-front.png ) |
...
특히 양말 신고 발 올려두면 정말 오래 책상에 앉게 된다.
